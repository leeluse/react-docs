      ...
      <section className="flex flex-col gap-8">
        ...
        <section id="use-state">
          ...
          <div>
            ...
            <p>
              리액트에서 렌더링은 함수 컴포넌트의 <code className="text-sky-200">return</code>,
              클래스 컴포넌트의 <code className="text-amber-100">render</code> 함수를 통해서 이뤄짐
            </p>
          ...
          <article>
            <h3 className="font-bold text-md sm:text-lg text-white pt-10">
              useState 구조 파악하기
            </h3>
