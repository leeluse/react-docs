...
export default function EventHandling() {
  return (
    <section className="flex flex-col m-5 gap-15 py-25 text-sm sm:text-base">
      ...
      <article>
        ...
        <section className=" flex gap-5">
          ...
          <div>
            <button
              className="p-2 border border-purple-500/30 rounded-sm bg-purple-500/30 point-cursor hover:bg-purple-500/40 transition duration-150"
              onClick={() => alert('hello')}
            >
              Click me
            </button>
            <div className="bg-white sm:w-120 rounded-sm p-5 my-4 border-2 border-black/20">
              ...
              <div className="text-end mt-10">
                <span className=" px-5 py-1 text-sm text-black rounded-sm border border-blue-900 ">
                  확인
                </span>
              </div>
            </div>
        ...
        <p className="">
          여기서 Click me 버튼을 누르게 되면 alert 함수를 사용하여 메시지 박스를 띄우게 된다
        </p>
        <p>
...
export function ReactEventSystem() {
  return (
    <article className="flex gap-10 sm:flex-row flex-col">
      <div>
        <h3 className="font-semibold text-base sm:text-lg text-white pb-3">
          • 리액트의 이벤트 시스템
        </h3>
        <p>
          리액트의 이벤트 시스템은 웹 브라우저의 HTML 이벤트와 인터페이스가 동일해서 사용법이 비슷함
        </p>
        <CodeBlock
          content={`const Say = () => {
      ...
      <div className="border border-slate-300 p-3 rounded-sm sm:w-1/3 h-fit sm:mt-20">
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-4">
        <h3 className="font-bold text-sm sm:text-base text-white pt-6 sm:pt-10">
          • Clipboard Event
        </h3>
        <OnCopy />
      </div>
      ...
      <div className="flex flex-col gap-4">
        <h3 className="font-bold text-sm sm:text-base text-white pt-6 sm:pt-10">• Media Event</h3>
        <Media />
      </div>
      <div className="flex flex-col gap-4">
        <h3 className="font-bold text-sm sm:text-base text-white pt-6 sm:pt-10">• Form Event</h3>
        <Form />
      </div>
      <div className="flex flex-col gap-4">
        <h3 className="font-bold text-sm sm:text-base text-white pt-6 sm:pt-10">• Image Event</h3>
        <Image />
      </div>
      <div className="flex flex-col gap-4">
        <h3 className="font-bold text-sm sm:text-base text-white pt-6 sm:pt-10">• Mouse Event</h3>
        <Mouse />
      </div>
      <div className="flex flex-col gap-4">
        <h3 className="font-bold text-sm sm:text-base text-white pt-6 sm:pt-10">
