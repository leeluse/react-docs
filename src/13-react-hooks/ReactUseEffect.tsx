        ...
        <section id="use-effect">
          ...
          <div className="flex flex-col pt-4">
            ...
            <span className="text-white/90 pb-3 pt-2">
              useEffect는 어플리케이션 내 컴포넌트의 여러 값들을 활용해 동기적으로 부수 효과를
              만드는 매커니즘이다
            </span>
          </div>
    ...
    <>
        ...
        <button onClick={handleClick}>+</button>
              ...
              <li className="font-semibold bg-slate-400/10 mt-3 p-2 rounded text-slate-300 text-sm">
                <code className="code-tag pink">useEffect</code>는 프록시나 데이터 바인딩 등을 통해
                값의 변화를 관찰하는 것이 아님 <br />
          ...
          <div className="pt-3">
            ...
            <p>
              로그를 보면 클린업 함수는 이전 <span className="code-tag text-pink">counter</span> 값,
              즉 이전 <code className="code-tag pink">state</code>를 참조해 실행된다는 것을 알 수
              있다
            </p>
            <p>
              클린업 함수는 새로운 값과 함께 렌더링된 뒤에 실행되기 때문에 위와 같은 메시지가
              나타난다 <br />
            </p>
          </div>
          <div className="pt-5">
            ...
            <p>
              로그를 보면 클린업 함수는 이전 <code className="code-tag pink"> counter</code> 값, 즉
          ...
          <div className="border-l pl-3 my-5">
            ...
            <p>
              ...
              <span className="text-emerald-400">
                클라이언트 사이드에서 실행되는 것을 보장해 준다
              </span>
            </p>
            <p>
              2.{' '}
              <span className="text-emerald-400">
                useEffect는 컴포넌트 렌더링이 완료된 이후 실행
              </span>
            ...
            <ul className="list-decimal list-inside py-3">
              <li className="py-3">
                ...
                <span className="text-sm">
                  ESLint 룰은 useEffect 인수 내부에서 사용하는 값 중 의존성 배열에 포함돼 있지 않은
                  값이 있을 시 경고를 발생시킴
                </span>
              </li>
              <li className="py-3">
