  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <article className="text-sm sm:text-base flex flex-col gap-2">
        ...
        <p className="leading-relaxed">
          getter와 setter를 지정해 프로퍼티에 접근하거나 값을 변경할 때의 비즈니스 로직을 구현할 수
          있습니다.
        </p>
      ...
      <article className="text-sm sm:text-base flex flex-col gap-2">
        ...
        <p className="leading-relaxed">
          클래스 내부에서 선언한 일반 메서드를 인스턴스 메서드라고 합니다.
        </p>
        <p className="leading-relaxed">
          이들은 클래스의 prototype에 등록되므로 프로토타입 메서드라고 부르기도 합니다.
        </p>
        ...
        />
        <p className="pt-3 leading-relaxed">
          Object.getPrototypeOf를 사용하면, 인수로 넘겨준 변수의 prototype 구조를 확인할 수
          있습니다.
        </p>
        <CodeBlock
      ...
      <article className="text-sm sm:text-base flex flex-col gap-2">
        ...
        <p className="leading-relaxed">
          정적 메서드는 클래스의 인스턴스가 아닌 클래스 자체 식별자를 통해 바로 호출하는
          메서드입니다.
        </p>
        <CodeBlock content={ClassBaseExample7} />
        <p className="leading-relaxed">
          정적 메서드 내부의 this는 클래스의 인스턴스가 아닌 클래스 함수 자체를 가리키므로, 인스턴스
          기반의 일반적인 this.state 등에는 접근할 수 없습니다.
        </p>
        <p className="leading-relaxed">
          이러한 이유로 리액트 클래스 컴포넌트 생명 주기 메서드인
          <span className="code-tag blue">static getDerivedStateFromProps(props, state)</span>
          에서는 this.state에 접근할 수 없습니다.
        </p>
        <p className="leading-relaxed">
          인스턴스를 생성하지 않아도 직접 접근하고 호출할 수 있어, 유틸리티 성격의 공통 로직을
          구현할 때 유용합니다.
        </p>
      </article>
      ...
      <article className="text-sm sm:text-base flex flex-col gap-2">
        ...
        <p className="leading-relaxed">
          ...
          <span className="code-tag pink">extends React.Component</span>
          또는
          <span className="code-tag pink">extends React.PureComponent</span>를 사용하는 것은
          대표적인 상속의 예시입니다.
        </p>
        <p className="leading-relaxed">
          extends 키워드를 사용해 부모 클래스를 상속받아 자식 클래스에서 해당 기능을 기반으로 확장해
          나갑니다.
        </p>
        <CodeBlock content={ClassBaseExample8} />
        <p className="leading-relaxed">
          자식 클래스인 Truck 객체에서도 부모로부터 상속받은 hook 메서드를 그대로 활용 가능한 것을
          확인할 수 있습니다.
        </p>
      </article>
    </div>
