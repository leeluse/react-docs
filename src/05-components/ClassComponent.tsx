      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
        <div className="flex-1 min-w-0 flex flex-col gap-3">
          ...
          <p className="leading-relaxed text-sm sm:text-base">
            자바스크립트에는 원래 클래스(class)가 존재하지 않았습니다. 구현을 하고 싶은 경우에는
            class 대신 prototype이라는 문법을 사용해야 했습니다.
          </p>
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-3">
          ...
          <p className="leading-relaxed text-sm sm:text-base">
            ES6부터 출시된 초기 함수형 컴포넌트는 state와 라이프사이클 API를 다룰 수 없었으나, React
            16.8 Hooks 도입으로 해결되었습니다.
          </p>
...
export function ClassVsFunction() {
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="leading-relaxed text-sm sm:text-base">
        리액트에서 컴포넌트를 선언하는 방식은 크게 함수형 컴포넌트와 클래스형 컴포넌트 두 가지가
        존재합니다.
      </p>
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
        <div className="flex-1 min-w-0 flex flex-col gap-3">
          <h3 className="font-semibold text-base sm:text-lg text-base-heading">
            • 클래스형 컴포넌트
          </h3>
      ...
      <article className="text-sm sm:text-base mt-2">
        <p className="leading-relaxed">
          <span className="font-semibold text-base-heading">주요 차이점:</span> state 관리 및
          라이프사이클 기능 수행 방식의 차이, 그리고 클래스의 경우 메서드를 내부 프로토타입에 임의로
          정의한다는 점 등이 있습니다.
        </p>
      </article>
    </div>
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="leading-relaxed text-sm sm:text-base">
          화살표 함수(Arrow function)는 ES6에서 추가된 새로운 표현식으로, 기존 function 선언식을
          온전히 대체하기보다 매개변수로 콜백을 넘기는 등 특정 상황에서 간결함을 극대화할 때
          유용합니다.
        </p>
        ...
        <div className="bg-black/5 dark:bg-white/5 p-5 rounded-lg border border-base-border/50 mt-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            <div className="flex-1 min-w-0 flex flex-col gap-2">
              <p className="text-xs sm:text-sm font-semibold text-base-heading">
                • 일반 function으로 구현 시
              </p>
              <CodeBlock content={ArrowExample_common} />
              <p className="text-xs sm:text-sm leading-relaxed">
                일반 함수는{' '}
                <span className="font-semibold text-base-heading">자신이 속한 객체</span>를 this로
                가리킵니다.
              </p>
            </div>
            <div className="flex-1 min-w-0 flex flex-col gap-2">
              ...
              <p className="text-xs sm:text-sm leading-relaxed">
                ...
                <span className="font-semibold text-base-heading">
                  자신이 선언된 상위 컨텍스트(렉시컬 환경)
                </span>
                의 this를 그대로 상속하여 가리킵니다.
              </p>
            </div>
          </div>
        </div>
