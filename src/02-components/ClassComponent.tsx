    ...
    return (
        <div>
            <h2 className="font-bold text-2xl text-primary py-5" >함수형 컴포넌트 vs 클래스형 컴포넌트</h2>
                        <p className="font-bold text-[14px] text-white pb-4">컴포넌트를 선언하는 방식은 총 두 가지이며, 하나는 함수형 컴포넌트 다른 하나는 클래스형 컴포넌트를 선언하는 방식이 있다.</p>
            ...
            <article className="font-md text-[14px]">
                <p className=""><span className=' text-white'>둘의 차이점:</span> state와 라이프사이클 기능을 수행하는 것 / 임의 메서드를 정의할 수 있다는 것</p>
            </article>
        </div>
    )
}
            ...
            <div className="flex gap-10">
                <div className="flex-1">
                    ...
                    <div className="bg-slate-800/5 p-4 rounded-2xl border mt-10 border-slate-400/10">
                        <p className="font-bold text-[16px] text-white pb-2">화살표 함수가 대체할 수 없는 이유?</p>
                        <div className="flex gap-4">
                            <div className="flex-1">
                                <p className="text-sm text-slate-300">• 일반 function으로 함수 구현 시</p>
                                <CodeBlock content={ArrowExample_common} />
                                <p className="text-[13px]">일반 함수는  <span className='text-slate-300'>자신이 종속된 객체를</span> this로 가리킨다</p>
                            </div>
                            <div className="flex-1">
                                <p className="text-sm text-slate-300">• 화살표 함수로 함수 구현 시</p>
                                <CodeBlock content={ArrowExample_arrow} />
                                <p className="text-[13px]">화살표 함수는 <span className='text-slate-300'>자신이 종속된 인스턴스를</span> this로  가리킨다</p>
                            </div>
                        </div>
                    </div>
                </div>
